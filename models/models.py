...
def create_modules(module_defs, img_size, cfg):
    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            modules.add_module('CBAM',CBAM(output_filters[-1]))
        ...
        elif mdef['type'] == 'DyHead':  # yolov3-spp-pan-scale
            channels = mdef['filters']
            num_blocks = mdef['num_blocks']
            layers = mdef['from'] if 'from' in mdef else []
            modules = DyHead(num_blocks=num_blocks,L=layers,S=img_size,C=channels)
...
class Darknet(nn.Module):
    ...
    def forward(self, x, augment=False, verbose=False):
        ...
        else:  # Augment images (inference and testImage only) https://github.com/ultralytics/yolov3/issues/931
    ...
    def forward_once(self, x, augment=False, verbose=False):
        ...
        # Augment images (inference and testImage only)
